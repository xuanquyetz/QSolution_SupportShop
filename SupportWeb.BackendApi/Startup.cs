...
using SupportWeb.Application.System.Users;
using SupportWeb.Data.EF;
using SupportWeb.Data.Entities;
using SuppportShop.Utilities.Constants;

namespace SupportWeb.BackendApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<SupportShopDbContext>(options =>
        options.UseSqlServer(Configuration.GetConnectionString(SystemConstants.MainConnectionString)));
            services.AddIdentity<AppUser, AppRole>()
               .AddEntityFrameworkStores<SupportShopDbContext>()
            ...
            {
                q.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger SupportWeb", Version = "1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(q =>
            {
                q.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger SupportWeb v1");
            });
